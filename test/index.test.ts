...
import GpWebpayRequest, {
  GpWebpayRequestCurrency
} from '../src/GpWebpayRequest'
...
const client = new GpWebpayClient(
...
test('create response - OK', () => {
  ...
  const response = client.createResponse(data)
